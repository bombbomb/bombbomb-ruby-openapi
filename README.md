...
- Build date: 2016-09-08T19:38:00.542Z
...
```shell
gem install ./bombbomb-{$api_version}.gem
```
(for development, run `gem install --dev ./bombbomb-{$api_version}.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'bombbomb', '~> {$api_version}'
