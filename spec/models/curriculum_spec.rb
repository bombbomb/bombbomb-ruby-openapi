...
# Unit tests for BombBomb::Curriculum
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Curriculum' do
  before do
    # run before each test
    @instance = BombBomb::Curriculum.new
  end
  ...
  describe 'test an instance of Curriculum' do
    it 'should create an instact of Curriculum' do
      expect(@instance).to be_instance_of(BombBomb::Curriculum)
    end
  end
